...
func (a *App) SetupRoutes() {
	...
	product.RegisterRoutes(api, a.Container.ProductHandler, a.Container.ProductCategoryHandler, a.Container.ProductAttributeHandler, a.Container.AuthMiddleware)
	setupSwagger(a.r)
}
